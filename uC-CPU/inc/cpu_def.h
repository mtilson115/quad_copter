...
#define  CPU_CRITICAL_METHOD_STATUS_STK            2u   /* Push/Pop     int32_t status onto stk     (see Note #1b).         */
#define  CPU_CRITICAL_METHOD_STATUS_LOCAL          3u   /* Save/Restore int32_t status to local var (see Note #1c).         */
