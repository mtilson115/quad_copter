...
#define UART_INT_RX_CHAR        (0)                  	/* Interrupt on every int8_t received */
...
/******************************************************************************
 * Function:        void OpenUARTx(uint32_t config1,
 *									uint32_t config2,
 *									uint32_t ubrg)
 *
...
/******************************************************************************
 * Function:        void ConfigIntUART1(int32_t config)
 *
...
/******************************************************************************
 * Function:        void SetPriorityIntUx(int32_t pri)
 *
...
/******************************************************************************
 * Function:        void SetSubPriorityIntUx(int32_t sub)
 *
...
/******************************************************************************
 * Function:        int32_t UARTxGetErrors(void)
 ...
 *****************************************************************************/
#if defined(_UART1)
#define getcUART1           (int8_t)ReadUART1
#endif

#if defined(_UART2)
#define getcUART2           (int8_t)ReadUART2
#endif


/******************************************************************************
 * Function:        void putcUARTx(int8_t c)
 *
 ...
 *****************************************************************************/
#if defined(_UART1)
#define putcUART1(c)           do{while(!U1STAbits.TRMT); WriteUART1((int32_t)(c));}while(0)
#endif

#if defined(_UART2)
#define putcUART2(c)           do{while(!U2STAbits.TRMT); WriteUART2((int32_t)(c));}while(0)
#endif


/******************************************************************************
 * Function:        void putsUARTx(const int8_t *buffer)
 *
 ...
 *****************************************************************************/
#if defined(_UART1)
void putsUART1(const int8_t* buffer);
#endif

#if defined(_UART2)
void putsUART2(const int8_t* buffer);
#endif


/******************************************************************************
 * Function:        void WriteUART1(uint32_t data)
 *
...
/******************************************************************************
 * Function:        int8_t ReadUART1(void)
 *
...
/******************************************************************************
 * Function:        int32_t DataRdyUARTx(void)
 *
...
/******************************************************************************
 * Function:        int32_t BusyUARTx(void)
 *
...
/******************************************************************************
 * Function:        uint32_t getsUART1(uint32_t length,
 *											int8_t* buffer,
 *											uint32_t uart_data_wait);
 *
 * Description:		Checks to see if a data is ready is in UARTx
 *
 * PreCondition:    None
 ...
 *****************************************************************************/
#if defined(_UART1)
uint32_t getsUART1(uint32_t length, int8_t* buffer, uint32_t uart_data_wait);
#endif

#if defined(_UART2)
uint32_t getsUART2(uint32_t length, int8_t* buffer, uint32_t uart_data_wait);
#endif


/******************************************************************************
 * Function:        void UARTxEnableAutoAddr(int32_t address)
 *
